...
前面几章回答了“谁用掉回合、失误成本多高、有没有回收回合”。这一章开始回答更直接的问题：当球员真的完成投篮或罚球时，他把机会转成得分的效率如何？
...
因此 TS% 通常是阅读得分效率的第一选择，但它也不能脱离角色。低使用率球员的高 TS% 可能来自精选机会；高使用率球员维持高 TS%，难度通常更高。
...
读 Reaves 时，TS% 分布要和第 4 章的使用率一起放在脑中。如果他在后卫组效率偏右，同时使用率也不是低位，那么这比“命中率不错”更有信息量：它说明他在一定责任下仍能保持终结质量。
...
三分命中率只回答“远投准不准”。eFG% 回答“投篮出手的得分价值”。TS% 回答“所有投篮和罚球机会合起来的得分效率”。现代篮球评价得分手时，通常至少要同时看出手量、使用率和 TS%。下一章会继续拆“出手量”里最重要的现代空间变量：三分产量。
