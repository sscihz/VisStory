...
教材会从回合、节奏、每 36 分钟、每 100 回合、Four Factors、使用率、失误率、篮板率、eFG%、TS%、三分出手结构等基本概念开始。每章都配套 Python 源代码和真实数据图表，重点用分布图、分位置图和阈值线帮助读者把“36 分钟出手 8 次三分”“使用率 30%”“失误率 12%”这类数字转化成可理解的篮球语言。

## 数据与参考

- 数据抓取参考：[suren-nba/surennba_stats](https://github.com/suren-nba/surennba_stats)
